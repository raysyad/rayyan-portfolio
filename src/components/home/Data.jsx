...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Rayyan Irsyad
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">UI/UX Designer, Wordpress, Microsoft Office & Workspace</h3>
            <p className="home__description">Seorang mahasiswa Universitas Brawijaya Malang dan dibekali skill dasar UI/UX Designer, wordpress & Microsoft office & workspace</p>
